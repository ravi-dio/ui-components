...
Indeterminate is not supported as of now.

export const basicCheckboxTemplate = () => <GoACheckbox name="desserts" text="Ice Cream" value="10"></GoACheckbox>

<Story name="Basic">{ basicCheckboxTemplate.bind({}) }</Story>

Hover or bring the focus to the checkbox to see the visual indications.
...
<Tabs>
  ...
  <Tab label="React">
    <CodeSnippet code={`<GoACheckbox name="desserts" text="Ice Cream" value="10"></GoACheckbox>`} lang="jsx" />
  </Tab>
</Tabs>

### checked

export const checkedCheckboxTemplate = () => <GoACheckbox name="desserts" text="Ice Cream" value="10" checked></GoACheckbox>

<Story name="Checked">{ checkedCheckboxTemplate.bind({}) }</Story>
...
export const onChangeCheckboxTemplate = () => <GoACheckbox name="desserts" text="Ice Cream" onChange={(name, value) => console.log(name, value)}></GoACheckbox>

<Story name="OnChange">{ onChangeCheckboxTemplate.bind({}) }</Story>
...
<Tabs>
  ...
  <Tab label="Angular">
    <CodeSnippet code={`<goa-checkbox name="desserts" text="Ice Cream" value="10" (onChange)="console.log($event.name, $event.value)" ></goa-checkbox>`} lang="html" />
  </Tab>
  <Tab label="React">
    <CodeSnippet code={`<GoACheckbox name="desserts" text="Ice Cream" value="10" onChange={(name, value) => console.log(name, value)}></GoACheckbox>`} lang="jsx" />
  </Tab>
</Tabs>
